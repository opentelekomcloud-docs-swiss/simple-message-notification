...
-  Parameter description
   ...
   .. table:: **Table 2** Statement elements description
      ...
      |                       |                                                                                                                                                                                                                          |                                                                                                                                                                   |
      | NotPrincipal          | -  **NotPrincipal**: object to which the statement does not apply                                                                                                                                                        | -  If you enter **CSP**, you must specify user information in the format **urn:csp:iam::domainId:root**. Obtain the account IDdomain ID of each user you specify. |
