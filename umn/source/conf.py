...
otcdocs_repo_name = 'opentelekomcloud-docs-swiss/simple-message-notification'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/simple-message-notification/umn/'
...
html_title = "Simple Message Notification - User Guide"
